use rich_rust::renderables::table::{Table, Column};
...
fn test_wide_char_in_narrow_column() {
    let mut table = Table::new()
        ...
        .ascii(); // Use ASCII to make length calc easier
    ...
    assert_eq!(header_cell_len, row_cell_len, "Table border misalignment detected! Header: {}, Row: {}");
}
